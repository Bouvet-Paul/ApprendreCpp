...
int main() {
    ...
    else
    {
        ...
        cout << "+" << setfill('-') << setw(18) << "+" << setfill('-') << setw(8) << "+" << setfill('-') << setw(8) << "+" << setfill('-') << setw(8) << "+" << setfill(' ') << endl;
        do
        {
            ...
            if (leFichier.good())//Si les valeurs ont bien été lues
            {
                ...
                cout << "|" << setw(17) << left << pays << "|" << setw(7) << right << nbOr << "|" << setw(7) << nbArgent << "|" << setw(7) <<nbBronze << "|" << endl;
